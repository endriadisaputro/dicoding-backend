...
Jadi, fungsi orderCoffee() akan selalu mengembalikan nilai null, karena kode return coffee akan 
dieksekusi terlebih dulu dibandingkan dengan coffee = "Kopi sudah jadi!";. 
...
Bagaimana cara menerapkannya dalam kode? Pertama, kita tambahkan parameter dengan nama callback pada 
fungsi asynchronous.
*/
...
/*
Kemudian kita panggil atau gunakan callback yang diisikan dengan 
data yang akan dibawa (coffee) ketika task selesai dilakukan.
*/
setTimeout(()=>{
	coffee="coffee sudah jadi";
	callback(coffee);
...
Sehingga, kita bisa menghapus kode return coffee;. Keseluruhan fungsi akan tampak seperti ini:
*/
const orderCoffee=callback=>{
	let	coffee=null;
	console.log("Sedang membuat coffee, silakan tunggu...");
