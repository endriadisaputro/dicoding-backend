/*
Promise merupakan sebuah objek yang digunakan untuk membuat sebuah komputasi (kode) ditangguhkan dan 
berjalan secara asynchronous [5]. 
...
const executorFunction = (resolve, reject)=>{
	...
	if(isCoffeeMakerReady){
		resolve("coffee berhasil dibuat");
	} else{
		reject("coffee telah habis");
	}
}
...
maka executor function akan mengeksekusi reject() dengan membawa pesan penolakan “Coffee telah habis”.
*/



/*
Executor function memiliki dua parameter, 
yaitu resolve dan reject yang berupa fungsi. Berikut penjelasan detailnya:
...
Parameter ini merupakan fungsi yang dapat menerima satu parameter dan digunakan untuk 
memberikan alasan kenapa Promise tidak dapat terpenuhi. Ketika fungsi ini terpanggil, 
