...
const gridCoffeeBeans=()=>{
	return new Promise((resolve,reject)=>{
		console.log("menggiling biji coffee");
		setTimeout(()=>{
			resolve("coffee sudah siap");
		},1000);
	})
}
...
/*
Keduanya dapat berjalan bersamaan. Kita akan memanfaatkan Promise.all() untuk 
menjalankan kedua fungsi di atas sebelum fungsi brewCoffee(). 
...
/*
Ketika kode di atas dieksekusi, kita perlu menunggu dua (2) detik untuk proses boilWater dan grindCoffeeBeans 
(durasi terlama dari promise yang dijalankan dari Promise.all()). Ini menunjukkan bahwa semua promise 
di dalam Promise.all() berjalan bersamaan dan menunggu sampai semua proses di dalamnya selesai dijalankan.

Yang perlu kita perhatikan, urutan nilai yang dihasilkan oleh method ini sesuai dengan promise yang kita 
tentukan pada parameternya [ 'Air panas sudah siap!', 'Kopi sudah siap!' ]
